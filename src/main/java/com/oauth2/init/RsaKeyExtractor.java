...
public class RsaKeyExtractor implements ApplicationRunner {
    ...
    @Autowired
    private RsaKeyPublicSecuritySigner rsaPublicKeySecuritySigner;

    @Override
    public void run(ApplicationArguments args) throws Exception {

        String path = "/Users/sinhyeonseo/IdeaProjects/spring/oauth2/oauth2/src/main/resources/certs/";
